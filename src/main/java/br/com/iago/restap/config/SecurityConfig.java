...
import br.com.iago.restap.securityJwt.JwtTokenFilter;
...
public class SecurityConfig   {
	...
	public PasswordEncoder passwordEncoder() {
		...
		Pbkdf2PasswordEncoder pbkdf2 = new Pbkdf2PasswordEncoder("", 8, 185000, SecretKeyFactoryAlgorithm.PBKDF2WithHmacSHA256);
